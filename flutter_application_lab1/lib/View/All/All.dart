...
class _AllState extends State<All> {
  ...
  Widget build(BuildContext context) {
    ...
    // print("rebuild");
    // List<String> listsuggest = ['Learn OOP','Learn TCC','Learn French','Learn English','Learn TAA'];
// Padding(
//           padding: const EdgeInsets.all(8.0),
//           child: SearchAnchor(
...
//               return ListTile(
//                 title: Text(listsuggest.elementAt(index),style: const TextStyle(fontWeight:FontWeight.w500),),
//                 onTap: () {
//                   setState(() {
//                     controller.closeView(listsuggest.elementAt(index));
//                   });
//                 },
//               );
//             });
